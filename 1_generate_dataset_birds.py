...
from datasets.birds import BirdsDataset


def build_parser(dataset: BirdsDataset) -> argparse.ArgumentParser:
    config = GenerationConfig()
    parser = argparse.ArgumentParser(description="Generate the correlated birds dataset.")
...
def main() -> None:
    ...
    if not args.skip_distribution:
        ...
        print(f"Saved birds distribution to: {distribution_csv}")
    ...
    print(f"Saved generated birds metadata to: {metadata_path}")
